...
export default class CurriculumPage extends React.Component {
    ...
    componentDidMount() {
        ...
        let url = settings.sws.baseURL + "/student/v5/curriculum.json?year=2009&quarter=summer&future_terms=2&department_abbreviation=cse&college_abbreviation=engr";
